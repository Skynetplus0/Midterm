    ...
    public partial class InitPostgres : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuestQueryUsages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeopleNamesJson = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuestQueryUsages_ClientKey_QueryDate",
                table: "GuestQueryUsages",
                columns: new[] { "ClientKey", "QueryDate" },
                unique: true);
